<template>
  <form @submit.prevent="resetPassword">
    ...
    <div class="mb-2">
        ...
        <input type="password" name="password_confirmation" id="password_confirmation" v-model="form.password_confirmation" class="border border-gray-400 py-1 px-2">
    </div>

    </div>
    <button type="submit" class="bg-gray-400 py-1 px-3 rounded">Set password</button>
  </form>
</template>
